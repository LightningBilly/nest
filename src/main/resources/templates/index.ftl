		...
		<div class="container ">
			...
			<div style="text-align: center;width: 100%;margin-top: 2.2rem;">
				...
				<a class="btn btn-outline-danger" target="_blank"
				   href="http://wpa.qq.com/msgrd?v=3&uin=${firstPage.contactQQ}&site=qq&menu=yes">在线QQ</a>
			</div>
		</div>
	</section>
	<!-- 标题和名称↑ -->
	...
	<div id="picture" class="container">
		...
		<div class="row">
			...
			<div class="col-6 col-sm-6 col-md-6 col-lg-3 col-xl-3">
				<div class="card">
					<a href="//yiyjm.com/static/photos/ipresenter/index.html" target="_blank">
			...
			<div class="col-6 col-sm-6 col-md-6 col-lg-3 col-xl-3">
				<div class="card">
					<a href="//yiyjm.com/static/photos/rotate/index.html" target="_blank">
